...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: ZrLdb-h3S7i/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: 5PZra_W0U4z/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(defaultcss.all, sty.svg__lwPzY)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(defaultcss.all, sty.svg___5V9th)}
                role={"img"}
              />
            ),
