...
import * as sty from "./PlasmicPost.module.css"; // plasmic-import: s9pms31Q_F/css
...
export const PlasmicPost__ArgProps = new Array<ArgPropType>("children");
